...
const base =
  ...
  "hover:border-border-hover hover:text-foreground hover:bg-[oklch(1_0_0_/_4%)] " +
 ...
 * SecondaryButton
 *
 * Ghost-style button with a subtle border. Renders as <button> by default;
 * pass `href` to render as a link.
 *
 * @example
 * <SecondaryButton href="/resume.pdf" external>Resume</SecondaryButton>
